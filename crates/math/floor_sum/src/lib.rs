...
///     499999999500000000
/// );
/// assert_eq!(floor_sum(14, 23, -7, -39), -58);
/// ```
pub fn floor_sum(n: i128, m: i128, a: i128, b: i128) -> i128 {
    assert!(m > 0);
    assert!(n > 0);
    let mut res = 0;
    let a = if a < 0 {
    ...
    res + floor_sum_unsigned(n as u128, m as u128, a, b) as i128
}
